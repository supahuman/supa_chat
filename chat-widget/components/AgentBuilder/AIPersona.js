          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-3">
              ...
              <button
                ...
                className="flex items-center space-x-2 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300 px-4 py-2 rounded-md hover:bg-gray-300 dark:hover:bg-gray-500 transition-colors"
              >
                <X className="w-4 h-4" />
                <span>Cancel</span>
              </button>
